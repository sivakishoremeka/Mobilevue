...
import com.mobilvue.data.GridViewData;
import com.mobilvue.data.MovieEngine;
...
public class SearchFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		VodActivity factivity=(VodActivity) getActivity();
		...
		(rootView.findViewById(R.id.search_imgbtn_fs))
		.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				EditText Search_et = ((EditText)rootView.findViewById(R.id.search_et_fs));
